...
const AddTourists = () => {
    ...
    const handleAddSpot=e=>{
        ...
        const addSpot={image,spotName,country,location,short,average,season,travel,total,userName,userEmail,countryImage}
        console.log(addSpot)

        // send server
        fetch('https://touristspot.vercel.app/addSpot',{
            method: "POST",
            headers:{
            ...
            <div className="bg-amber-50">
                <form  onSubmit={handleAddSpot}>
                    ...
                    <div className="flex gap-10 px-10 ">
                        ...
                        <div className="form-control w-full flex-1">
                            <label className="label">
                                <span className="label-text text-xl font-bold text-rose-500"> Country Image </span>
                            </label>
